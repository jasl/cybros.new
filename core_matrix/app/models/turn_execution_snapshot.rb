class TurnExecutionSnapshot
  ...
  def turn_origin
    ...
    execution_contract&.turn_origin_payload || {}
  end
  ...
  def provider_context
    ...
    execution_contract&.provider_context_payload || {}
  end
