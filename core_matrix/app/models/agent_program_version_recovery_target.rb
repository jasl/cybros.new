class AgentProgramVersionRecoveryTarget
  attr_reader :agent_program_version, :selector_source

  def initialize(agent_program_version:, resolved_model_selection_snapshot:, selector_source:, rebind_turn:)
