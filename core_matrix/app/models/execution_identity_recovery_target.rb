class ExecutionIdentityRecoveryTarget
  attr_reader :agent_definition_version, :selector_source

  def initialize(agent_definition_version:, resolved_model_selection_snapshot:, selector_source:, rebind_turn:)
