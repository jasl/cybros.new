class AgentSnapshotRecoveryTarget
  attr_reader :agent_snapshot, :selector_source

  def initialize(agent_snapshot:, resolved_model_selection_snapshot:, selector_source:, rebind_turn:)
