module ProgramAPI
  class BaseController < ActionController::API
    ...
    rescue_from ExecutionRuntimes::Reconcile::MissingRuntimeFingerprint, with: :render_unprocessable_entity

    private

    attr_reader :current_agent_session, :current_deployment, :current_execution_runtime
