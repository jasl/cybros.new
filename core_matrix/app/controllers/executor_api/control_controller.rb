  ...
  class ControlController < BaseController
    ...
    def poll
      mailbox_items = AgentControl::Poll.call(
        executor_session: current_executor_session,
    ...
    def resolve_target!(payload)
      ...
      if method_id.start_with?("process_")
        ...
        raise ActiveRecord::RecordNotFound, "Couldn't find ProcessRun" unless process_run.executor_program_id == current_executor_program.id
