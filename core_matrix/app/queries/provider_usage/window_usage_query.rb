  ...
  class WindowUsageQuery
    ...
    def call
      UsageRollup
        ...
        .map do |provider_handle, model_ref, operation_kind, event_count, success_count, failure_count, input_tokens_total, output_tokens_total, media_units_total, total_latency_ms, estimated_cost_total|
          Entry.new(
            window_key: @window_key,
