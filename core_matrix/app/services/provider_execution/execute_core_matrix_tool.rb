module ProviderExecution
  class ExecuteCoreMatrixTool
    ...
    def call
      ...
      when "subagent_send"
        session = owned_subagent_connection!
        message = SubagentConnections::SendMessage.call(
      ...
      when "subagent_wait"
        SubagentConnections::Wait.call(
          subagent_connection: owned_subagent_connection!,
          timeout_seconds: arguments.fetch("timeout_seconds")
        )
      when "subagent_close"
        session = SubagentConnections::RequestClose.call(
          subagent_connection: owned_subagent_connection!,
      ...
      when "subagent_list"
        {
          "entries" => SubagentConnections::ListForConversation.call(conversation: @conversation),
        }
    ...
    def owned_subagent_connection!
      @conversation.owned_subagent_connections.find_by!(
        public_id: arguments.fetch("subagent_connection_id")
      )
    end
