module Workflows
  class BlockNodeForFailure
    ...
    DEFAULT_AUTOMATIC_RETRY_DELAYS = {
      ...
      "agent_transport_failed" => 10.seconds,
      ...
      "agent_connection_unavailable" => 10.seconds,
      "execution_runtime_connection_unavailable" => 10.seconds,
      "invalid_provider_response_contract" => 5.seconds,
      "invalid_agent_response_contract" => 5.seconds,
