module Processes
  class Provision
    ...
    def acquire_process_lease!(process_run)
      execution_runtime_connection = ExecutionRuntimeConnections::ResolveActiveConnection.call(
        execution_runtime: process_run.execution_runtime
      )
      return if execution_runtime_connection.blank?

      Leases::Acquire.call(
        leased_resource: process_run,
        holder_key: execution_runtime_connection.public_id,
