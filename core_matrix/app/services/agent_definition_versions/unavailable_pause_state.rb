module AgentDefinitionVersions
  module UnavailablePauseState
    def self.pause_attributes(workflow_run:, agent_definition_version:, recovery_state:, reason:, occurred_at:, wait_reason_kind:)
      {
        wait_state: "waiting",
        ...
        blocking_resource_id: agent_definition_version.public_id,
