  ...
  class WriteZipBundle
    ...
    def call
      ...
      Zip::OutputStream.open(tempfile.path) do |zip|
        ...
        write_json_entry(zip, "workflow_edges.json", payload.fetch("workflow_edges"))
        write_json_entry(zip, "workflow_node_events.json", payload.fetch("workflow_node_events"))
        write_json_entry(zip, "workflow_artifacts.json", payload.fetch("workflow_artifacts"))
        ...
        write_json_entry(zip, "conversation_supervision_sessions.json", payload.fetch("conversation_supervision_sessions"))
        write_json_entry(zip, "conversation_supervision_messages.json", payload.fetch("conversation_supervision_messages"))
