    ...
    def call
      {
        ...
        "counts" => {
          ...
          "workflow_edge_count" => @payload.fetch("workflow_edges").length,
          "workflow_node_event_count" => @payload.fetch("workflow_node_events").length,
          "workflow_artifact_count" => @payload.fetch("workflow_artifacts").length,
          ...
          "conversation_supervision_session_count" => @payload.fetch("conversation_supervision_sessions").length,
          "conversation_supervision_message_count" => @payload.fetch("conversation_supervision_messages").length,
