module ProviderUsage
  class RecordEvent
    ...
    def initialize(installation:, user: nil, workspace: nil, conversation_id: nil, turn_id: nil, workflow_node_key: nil, agent_installation: nil, agent_deployment: nil, provider_handle:, model_ref:, operation_kind:, input_tokens: nil, output_tokens: nil, media_units: nil, latency_ms: nil, estimated_cost: nil, success:, entitlement_window_key: nil, occurred_at: Time.current)
