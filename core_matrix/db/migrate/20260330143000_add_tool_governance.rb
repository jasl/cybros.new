class AddToolGovernance < ActiveRecord::Migration[8.2]
  def change
    ...
    create_table :tool_definitions do |t|
      t.references :installation, null: false, foreign_key: true
      t.references :capability_snapshot, null: false, foreign_key: true
      t.uuid :public_id, null: false, default: -> { "uuidv7()" }
    ...
    add_index :tool_definitions, [:capability_snapshot_id, :tool_name], unique: true, name: "idx_tool_definitions_snapshot_tool"
