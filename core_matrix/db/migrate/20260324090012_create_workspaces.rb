class CreateWorkspaces < ActiveRecord::Migration[8.2]
  def change
    create_table :workspaces do |t|
      ...
      t.belongs_to :user_program_binding, null: false, foreign_key: true
    ...
    add_index :workspaces, :user_program_binding_id,
      unique: true,
      where: "is_default",
      name: "index_workspaces_on_user_program_binding_id_default"
  end
end
