class AddFeatureContractDocumentToAgentDefinitionVersions < ActiveRecord::Migration[8.0]
  ...
  def up
    add_reference :agent_definition_versions, :feature_contract_document, foreign_key: { to_table: :json_documents }, null: true
    ...
    MigrationAgentDefinitionVersion.find_each do |agent_definition_version|
      ...
      document = MigrationJsonDocument.find_or_create_by!(
        ...
        document_kind: "agent_feature_contract",
      ...
      agent_definition_version.update_columns(feature_contract_document_id: document.id)
    end

    change_column_null :agent_definition_versions, :feature_contract_document_id, false
  end

  def down
    remove_reference :agent_definition_versions, :feature_contract_document, foreign_key: { to_table: :json_documents }
  end
end
