...
class ExecutionApiAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "request_attachment rejects an execution session from another runtime" do
    ...
    post "/execution_api/attachments/request",
      ...
      headers: execution_api_headers(other_registration.fetch(:execution_machine_credential)),
      as: :json
