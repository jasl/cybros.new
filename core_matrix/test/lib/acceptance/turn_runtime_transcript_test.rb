...
class AcceptanceTurnRuntimeTranscriptTest < ActiveSupport::TestCase
  test "builds a readable timeline with actor lanes and phase sections" do
    ...
    assert_includes markdown, "## Runtime"
    ...
    assert_includes markdown, "[researcher#1] A shell command finished in /workspace/game-2048"
    assert_includes markdown, "[main] A shell command finished in /workspace/game-2048"
    assert_includes markdown, "[main] A shell command is running in /workspace/game-2048"
