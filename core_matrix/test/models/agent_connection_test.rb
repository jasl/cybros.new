...
class AgentConnectionTest < ActiveSupport::TestCase
  test "allows only one active connection per agent" do
    ...
    first_version = create_agent_snapshot!(installation: installation, agent: agent)
    second_version = create_agent_snapshot!(
