...
class ToolBindings::FreezeForWorkflowNodeTest < ActiveSupport::TestCase
  ...
  test "materializes round-scoped agent tools that are absent from the static capability snapshot" do
      ...
      tool_catalog: [
        {
          ...
          "implementation_ref" => "fenix/workspace_write_file",
    ...
    assert_equal "fenix/workspace_write_file", binding.tool_implementation.implementation_ref
        ...
        tool_catalog: [
          {
            ...
            "tool_kind" => "effect_intent",
            "implementation_source" => "agent",
            "implementation_ref" => "fenix/subagent_spawn",
            "input_schema" => { "type" => "object", "properties" => {} },
            "result_schema" => { "type" => "object", "properties" => {} },
            "streaming_support" => false,
            "idempotency_policy" => "best_effort",
