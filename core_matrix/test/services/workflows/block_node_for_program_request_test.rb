...
class Workflows::BlockNodeForProgramRequestTest < ActiveSupport::TestCase
  include ActiveJob::TestHelper

  test "moves a workflow node turn and run into agent program waiting" do
    ...
    mailbox_item = AgentControl::CreateAgentProgramRequest.call(
      ...
      logical_work_id: "program-tool:#{workflow_node.public_id}:tool-call-1",
    ...
    assert_enqueued_with(
      ...
      result = Workflows::BlockNodeForProgramRequest.call(
    ...
    assert_equal "execute_program_tool", workflow_run.wait_reason_payload["request_kind"]
