...
class AgentProgramVersions::RotateMachineCredentialTest < ActiveSupport::TestCase
  test "issues a fresh machine credential and invalidates the previous secret atomically" do
    ...
    result = AgentProgramVersions::RotateMachineCredential.call(
    ...
    assert_nil AgentProgramVersion.find_by_machine_credential(previous_credential)

    audit_log = AuditLog.find_by!(action: "agent_program_version.machine_credential_rotated")
