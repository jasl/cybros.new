    ...
    module System
      module Memory
        class Runtime
          ...
          def initialize(tool_call:, workspace_root:, conversation_id:, agent_program_version_id: nil)
            ...
            @memory_repository = Fenix::Memory::Store.new(workspace_root:, conversation_id:, agent_program_version_id:)
          end
