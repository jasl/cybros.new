...
class Fenix::Agent::Program::ExecuteProgramToolTest < ActiveSupport::TestCase
  test "executes the shared calculator contract fixture" do
    ...
    response = Fenix::Agent::Program::ExecuteProgramTool.call(payload: fixture_payload)
  ...
  test "delegates system tool execution through an injected boundary" do
    ...
    captured = nil
    response = Fenix::Agent::Program::ExecuteProgramTool.call(
      payload: payload,
