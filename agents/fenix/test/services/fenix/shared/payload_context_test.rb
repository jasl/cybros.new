...
class Fenix::Shared::PayloadContextTest < ActiveSupport::TestCase
  test "hydrates memory and preserves an explicit skill context" do
    Dir.mktmpdir("fenix-workspace-") do |workspace_root|
      ...
      context = Fenix::Shared::PayloadContext.call(
        ...
        memory_store: Fenix::Agent::Memory::Store.new(workspace_root: workspace_root, conversation_id: "conversation-1"),
        defaults: {
          "skill_context" => {
