...
class Fenix::Shared::ControlPlane::ClientTest < ActiveSupport::TestCase
    ...
    assert_equal(
      {
        "base_url" => "https://core-matrix.example.test",
        "agent_connection_credential" => "secret",
        "open_timeout" => Fenix::Shared::ControlPlane::Client::DEFAULT_OPEN_TIMEOUT,
        "read_timeout" => Fenix::Shared::ControlPlane::Client::DEFAULT_READ_TIMEOUT,
        "write_timeout" => Fenix::Shared::ControlPlane::Client::DEFAULT_WRITE_TIMEOUT,
      },
