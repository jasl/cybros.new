...
class Fenix::Plugins::RegistryTest < ActiveSupport::TestCase
  test "default registry composes environment tool names from plugin manifests" do
    ...
    assert_includes catalog.environment_tool_names, "workspace_tree"
    assert_includes catalog.environment_tool_names, "workspace_stat"
    assert_includes catalog.environment_tool_names, "workspace_find"
    ...
    assert_includes catalog.environment_tool_names, "memory_list"
    assert_includes catalog.environment_tool_names, "memory_append_daily"
    assert_includes catalog.environment_tool_names, "memory_compact_summary"
    ...
    assert_includes catalog.environment_tool_names, "process_exec"
  end
end
