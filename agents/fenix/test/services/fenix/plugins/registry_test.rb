...
class Fenix::Plugins::RegistryTest < ActiveSupport::TestCase
  test "default registry composes environment tool names from plugin manifests" do
    ...
    assert_includes catalog.environment_tool_names, "command_run_list"
    assert_includes catalog.environment_tool_names, "command_run_read_output"
    assert_includes catalog.environment_tool_names, "command_run_wait"
    assert_includes catalog.environment_tool_names, "command_run_terminate"
    ...
    assert_includes catalog.environment_tool_names, "browser_list"
    assert_includes catalog.environment_tool_names, "browser_navigate"
    assert_includes catalog.environment_tool_names, "browser_session_info"
    ...
    assert_includes catalog.environment_tool_names, "process_list"
    assert_includes catalog.environment_tool_names, "process_read_output"
    assert_includes catalog.environment_tool_names, "process_proxy_info"
  end
end
