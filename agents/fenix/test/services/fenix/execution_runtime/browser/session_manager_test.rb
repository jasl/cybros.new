...
class Fenix::ExecutionRuntime::Browser::SessionManagerTest < ActiveSupport::TestCase
  ...
  setup do
    Fenix::ExecutionRuntime::Browser::SessionManager.reset!
  end
  ...
  test "open registers a session and close removes it" do
    ...
    opened = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "open",
    ...
    assert Fenix::ExecutionRuntime::Browser::SessionManager.lookup(browser_session_id: browser_session_id)

    closed = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "close",
      browser_session_id: browser_session_id
    )

    assert_equal true, closed.fetch("closed")
    assert_nil Fenix::ExecutionRuntime::Browser::SessionManager.lookup(browser_session_id: browser_session_id)
  ...
  test "navigate get_content and screenshot dispatch through the stored host" do
    ...
    navigated = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "navigate",
      browser_session_id: browser_session_id,
      url: "https://example.com/docs"
    )
    content = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "get_content",
      browser_session_id: browser_session_id
    )
    screenshot = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "screenshot",
      browser_session_id: browser_session_id
    )
  ...
  test "list and info expose registered session metadata" do
    ...
    Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "navigate",
      browser_session_id: browser_session_id,
      url: "https://example.com/docs"
    )

    listed = Fenix::ExecutionRuntime::Browser::SessionManager.call(action: "list")
    info = Fenix::ExecutionRuntime::Browser::SessionManager.call(action: "info", browser_session_id: browser_session_id)
  ...
  test "list and info can be scoped to the owning execution" do
    ...
    owned = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "open",
      url: "https://example.com",
      host_factory: host_factory,
    ...
    listed = Fenix::ExecutionRuntime::Browser::SessionManager.call(action: "list", runtime_owner_id: "task-1")
    info = Fenix::ExecutionRuntime::Browser::SessionManager.call(
      action: "info",
    ...
    assert_raises(Fenix::ExecutionRuntime::Browser::SessionManager::ValidationError) do
      Fenix::ExecutionRuntime::Browser::SessionManager.call(
        action: "info",
        browser_session_id: owned.fetch("browser_session_id"),
        runtime_owner_id: "task-2"
  ...
  test "playwright host wraps broken pipes as host errors" do
    host = Fenix::ExecutionRuntime::Browser::SessionManager::PlaywrightHost.allocate
    ...
    error = assert_raises(Fenix::ExecutionRuntime::Browser::SessionManager::HostError) do
  ...
  test "playwright host falls back to a discovered managed browser root when the configured path is empty" do
    Dir.mktmpdir("fenix-playwright-root") do |tmpdir|
      ...
      host = Fenix::ExecutionRuntime::Browser::SessionManager::PlaywrightHost.new(
