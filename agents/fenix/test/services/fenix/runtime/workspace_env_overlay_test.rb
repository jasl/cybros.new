...
class Fenix::Runtime::WorkspaceEnvOverlayTest < ActiveSupport::TestCase
  test "returns an empty overlay when the workspace env file is absent" do
    Dir.mktmpdir("fenix-workspace-") do |workspace_root|
      assert_equal({}, Fenix::Runtime::WorkspaceEnvOverlay.call(workspace_root: workspace_root))
    end
  end
  ...
  test "parses comments blank lines and export prefixes" do
    Dir.mktmpdir("fenix-workspace-") do |workspace_root|
      ...
      assert_equal(
        ...
        Fenix::Runtime::WorkspaceEnvOverlay.call(workspace_root: workspace_root)
      )
    end
  end
  ...
  test "rejects invalid lines" do
    Dir.mktmpdir("fenix-workspace-") do |workspace_root|
      ...
      error = assert_raises(Fenix::Runtime::WorkspaceEnvOverlay::ValidationError) do
        Fenix::Runtime::WorkspaceEnvOverlay.call(workspace_root: workspace_root)
      end
