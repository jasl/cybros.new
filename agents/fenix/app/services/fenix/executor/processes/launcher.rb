module Fenix
  module Executor
    module Processes
      ...
      def initialize(process_run:, command_line:, proxy_port: nil, control_client: nil, environment: nil, manager: Fenix::Executor::Processes::Manager, proxy_registry: Fenix::Executor::Processes::ProxyRegistry)
