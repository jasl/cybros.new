    ...
    module ControlPlane
      ...
      class << self
        ...
        def build_default_client
          ...
          agent_connection_credential = ENV["CORE_MATRIX_AGENT_CONNECTION_CREDENTIAL"].to_s

          raise UnconfiguredError, "CORE_MATRIX_BASE_URL is required" if base_url.empty?
          raise UnconfiguredError, "CORE_MATRIX_AGENT_CONNECTION_CREDENTIAL is required" if agent_connection_credential.empty?
