      ...
      module ExecCommand
        ...
        class Runtime
          ...
          def execute_write_stdin
            ...
            Fenix::Runtime::CommandRunRegistry.release(command_run_id: command_run_id) if wait_for_exit && command_run_id.present? && !command_run&.session_closed
          end
          ...
          def execute_command_run_wait
            ...
            Fenix::Runtime::CommandRunRegistry.release(command_run_id: command_run_id) if command_run_id.present? && !command_run&.session_closed
          end
          ...
          def execute_command_run_terminate
            ...
            snapshot = Fenix::Runtime::CommandRunRegistry.terminate(command_run_id: command_run_id)
            raise ValidationError, "unknown command run #{command_run_id}" if snapshot.blank?
          ...
          def execute_one_shot_command(command_line:, timeout_seconds:, timeout_label:)
            ...
            if command_run_id.present?
              if preserve_snapshot
                Fenix::Runtime::CommandRunRegistry.release(command_run_id: command_run_id)
              else
          ...
          def read_available_output(command_run:, timeout_seconds:, command_run_id: command_run.command_run_id)
            ...
            ready.first.each_with_object([]) do |io, output_chunks|
              ...
              sanitized = Fenix::Runtime::CommandRunRegistry.sanitize_output_text(chunk)
