  ...
  module Hooks
    class ReviewToolCall
      ...
      SUPPORTED_TOOLS = {
        ...
        "browser_open" => true,
        "browser_session_info" => true,
        "browser_screenshot" => true,
        "calculator" => true,
        "command_run_list" => true,
        "command_run_read_output" => true,
        "command_run_terminate" => true,
        "command_run_wait" => true,
        "exec_command" => true,
        ...
        "process_exec" => true,
        "process_list" => true,
        "process_proxy_info" => true,
        "process_read_output" => true,
        "web_fetch" => true,
        "web_search" => true,
        "workspace_find" => true,
        "workspace_read" => true,
