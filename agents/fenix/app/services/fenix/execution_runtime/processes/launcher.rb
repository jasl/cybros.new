module Fenix
  module ExecutionRuntime
    module Processes
      ...
      def initialize(process_run:, command_line:, proxy_port: nil, control_client: nil, environment: nil, manager: Fenix::ExecutionRuntime::Processes::Manager, proxy_registry: Fenix::ExecutionRuntime::Processes::ProxyRegistry)
