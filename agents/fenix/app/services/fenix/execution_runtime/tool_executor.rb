  ...
  module ExecutionRuntime
    class ToolExecutor
      ...
      def self.error_payload_for(error)
        ...
        when Fenix::ExecutionRuntime::ToolExecutors::ExecCommand::ValidationError
          {
            "classification" => "semantic",
        ...
        when Fenix::ExecutionRuntime::Browser::SessionManager::ValidationError
          {
            "classification" => "semantic",
            "code" => "validation_error",
            "message" => error.message,
        ...
        when Fenix::ExecutionRuntime::ToolExecutors::Process::ValidationError
          {
            "classification" => "semantic",
            "code" => "validation_error",
            "message" => error.message,
      ...
      def initialize(context:, collector: nil, control_client:, cancellation_probe: nil)
      ...
      def execute(tool_call:, tool_invocation: nil, command_run: nil, process_run: nil)
        ...
        tool_registry_entry = Fenix::ExecutionRuntime::SystemToolRegistry.fetch!(normalized_tool_call.fetch("tool_name"))
      ...
      def validate_tool_call!(tool_call)
        ...
        raise UnsupportedToolError, "unsupported tool #{tool_name}" unless Fenix::ExecutionRuntime::SystemToolRegistry.supported_tool_names.include?(tool_name)
