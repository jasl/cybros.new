      ...
      [
        {
          ...
          "implementation_ref" => "fenix/executor/command_run",
        ...
        register!(
          ...
          executor: Fenix::ExecutionRuntime::ToolExecutors::ExecCommand,
        )
      end
      ...
      [
        {
          ...
          "mutates_state" => true,
          "implementation_source" => "execution_runtime",
          "implementation_ref" => "fenix/executor/process_run",
          "supports_streaming_output" => false,
          "input_schema" => {
            "type" => "object",
            "properties" => {
        ...
        register!(
          entries,
          catalog_entry: catalog_entry,
          executor: Fenix::ExecutionRuntime::ToolExecutors::Process,
        )
      end
      ...
      [
        {
          ...
          "mutates_state" => true,
          "implementation_source" => "execution_runtime",
          "implementation_ref" => "fenix/executor/browser_session",
          "supports_streaming_output" => false,
          "input_schema" => {
            "type" => "object",
            "properties" => {
        ...
        register!(
          entries,
          catalog_entry: catalog_entry,
          executor: Fenix::ExecutionRuntime::ToolExecutors::Browser,
        )
      end
