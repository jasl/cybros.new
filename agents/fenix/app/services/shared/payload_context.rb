module Shared
  class PayloadContext
    ...
    def agent_context
      ...
      {
        "profile_key" => projected["profile_key"],
        ...
        "model_selector_hint" => projected["model_selector_hint"],
    ...
    def workspace_agent_context
...

      {
        ...
        "settings_payload" => normalize_context_payload(explicit["settings_payload"]),
      }.compact
    end
