module ExecutionRuntime
  module Processes
    ...
    def initialize(process_run:, command_line:, proxy_port: nil, control_client: nil, environment: nil, manager: ExecutionRuntime::Processes::Manager, proxy_registry: ExecutionRuntime::Processes::ProxyRegistry)
