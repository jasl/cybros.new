      ...
      class Runtime
        ...
        def call
          ...
          when "browser_session_info"
            ...
            raise ExecutionRuntime::Browser::SessionManager::ValidationError, "unsupported browser tool #{@tool_call.fetch("tool_name")}"
          end
        end
        ...
        def session_manager
          ExecutionRuntime::Browser::SessionManager
        end
      end
    end
  end
