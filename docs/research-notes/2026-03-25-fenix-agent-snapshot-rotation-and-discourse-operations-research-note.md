...
`Fenix` is an external agent consumed by `Core Matrix`, not a module
...
- multiple agents need the same release-management semantics
...
- [/Users/jasl/Workspaces/Ruby/cybros/docs/archived-plans/core_matrix-docs-legacy-2026-04-17/behavior/agent-registration-and-capability-handshake.md](/Users/jasl/Workspaces/Ruby/cybros/docs/archived-plans/core_matrix-docs-legacy-2026-04-17/behavior/agent-registration-and-capability-handshake.md)
