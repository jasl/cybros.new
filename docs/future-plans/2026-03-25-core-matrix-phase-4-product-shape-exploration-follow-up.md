# Core Matrix Phase 4 Product-Shape Exploration Follow-Up
...
Validate that Core Matrix remains a reusable kernel after `Fenix` and the first
Web product surface exist.
