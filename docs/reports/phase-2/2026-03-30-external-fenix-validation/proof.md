# Independent External Fenix Validation
...
External registration, heartbeat, control-plane polling, runtime execution, and execution reporting all flowed over the external Fenix path instead of bundled runtime registration.
