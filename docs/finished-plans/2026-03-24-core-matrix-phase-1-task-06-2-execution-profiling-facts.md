...
- generic fact dimensions and nullable references so later runtime resources such as `ProcessRun`, `SubagentConnection`, or `HumanInteractionRequest` can attach without forcing schema redesign
