...
- Re-read the current versions of:
  ...
  - `app/services/runtime/control_loop.rb`
  - `app/services/runtime/control_worker.rb`
  - `app/services/runtime/execute_assignment.rb`
  - `app/services/processes/manager.rb`
  - `app/services/runtime_surface/report_collector.rb`
...
**Files:**
- Create: `app/services/plugins/manifest.rb`
- Create: `app/services/plugins/registry.rb`
- Create: `app/services/plugins/catalog.rb`
- Create: `app/services/plugins/system/exec_command/plugin.yml`
- Create: `app/services/plugins/system/workspace/plugin.yml`
- Create: `app/services/plugins/system/memory/plugin.yml`
- Modify: `app/services/runtime/pairing_manifest.rb`
- Test: `test/services/plugins/registry_test.rb`
...
Run: `bin/rails test test/services/plugins/registry_test.rb test/integration/external_runtime_pairing_test.rb`
...
```bash
git add app/services/plugins app/services/runtime/pairing_manifest.rb test/services/plugins/registry_test.rb test/integration/external_runtime_pairing_test.rb
...
**Files:**
- Create: `app/services/workspace/bootstrap.rb`
- Create: `app/services/workspace/env_overlay.rb`
- Create: `app/services/workspace/layout.rb`
- Create: `app/services/memory/store.rb`
- Create: `app/services/prompts/assembler.rb`
- Create: `prompts/SOUL.md`
- Create: `prompts/USER.md`
- Modify: `app/services/context/build_execution_context.rb`
- Test: `test/services/workspace/bootstrap_test.rb`
- Test: `test/services/workspace/env_overlay_test.rb`
...
Run: `bin/rails test test/services/workspace/bootstrap_test.rb test/services/workspace/env_overlay_test.rb test/services/prompts/assembler_test.rb`
...
```bash
git add app/services/workspace app/services/memory/store.rb app/services/prompts/assembler.rb prompts/SOUL.md prompts/USER.md test/services/workspace/bootstrap_test.rb test/services/workspace/env_overlay_test.rb test/services/prompts/assembler_test.rb
...
**Files:**
- Create: `app/services/plugins/system/exec_command/runtime.rb`
- Modify: `app/services/runtime/execute_assignment.rb`
- Modify: `app/services/hooks/project_tool_result.rb`
- Modify: `app/services/hooks/review_tool_call.rb`
- Test: `test/services/runtime/execute_assignment_test.rb`
...
Run: `bin/rails test test/services/runtime/execute_assignment_test.rb test/integration/runtime_flow_test.rb`
...
```bash
git add app/services/plugins/system/exec_command/runtime.rb app/services/runtime/execute_assignment.rb app/services/hooks/project_tool_result.rb app/services/hooks/review_tool_call.rb test/services/runtime/execute_assignment_test.rb test/integration/runtime_flow_test.rb
...
**Files:**
- Create: `app/services/plugins/system/workspace/runtime.rb`
- Create: `app/services/plugins/system/memory/runtime.rb`
- Modify: `app/services/runtime/execute_assignment.rb`
...
```bash
git add app/services/plugins/system/workspace/runtime.rb app/services/plugins/system/memory/runtime.rb app/services/runtime/execute_assignment.rb test/integration/workspace_flow_test.rb test/integration/memory_flow_test.rb
...
**Files:**
- Create: `app/services/web/fetch.rb`
- Create: `app/services/web/search.rb`
- Create: `app/services/web/firecrawl_client.rb`
- Create: `app/services/plugins/system/web/plugin.yml`
- Create: `app/services/plugins/system/web/runtime.rb`
- Modify: `README.md`
- Test: `test/services/web/fetch_test.rb`
- Test: `test/services/web/search_test.rb`
...
Run: `bin/rails test test/services/web/fetch_test.rb test/services/web/search_test.rb test/integration/web_tools_flow_test.rb`
...
```bash
git add app/services/web app/services/plugins/system/web README.md test/services/web/fetch_test.rb test/services/web/search_test.rb test/integration/web_tools_flow_test.rb
...
**Files:**
- Create: `app/services/browser/session_manager.rb`
- Create: `app/services/plugins/system/browser/plugin.yml`
- Create: `app/services/plugins/system/browser/runtime.rb`
- Modify: `Dockerfile`
- Modify: `README.md`
- Test: `test/services/browser/session_manager_test.rb`
...
Run: `bin/rails test test/services/browser/session_manager_test.rb test/integration/browser_tools_flow_test.rb`
...
```bash
git add app/services/browser app/services/plugins/system/browser Dockerfile README.md test/services/browser/session_manager_test.rb test/integration/browser_tools_flow_test.rb
...
**Files:**
- Create: `app/services/processes/launcher.rb`
- Create: `app/services/processes/proxy_registry.rb`
- Create: `app/services/plugins/system/process/plugin.yml`
- Create: `app/services/plugins/system/process/runtime.rb`
- Create: `config/caddy/Caddyfile`
- Create: `bin/fenix-dev-proxy`
- Modify: `app/services/runtime/pairing_manifest.rb`
- Modify: `README.md`
- Test: `test/services/processes/launcher_test.rb`
- Test: `test/services/processes/proxy_registry_test.rb`
...
Run: `bin/rails test test/services/processes/launcher_test.rb test/services/processes/proxy_registry_test.rb test/integration/process_tools_flow_test.rb`
...
```bash
git add app/services/processes app/services/plugins/system/process config/caddy/Caddyfile bin/fenix-dev-proxy app/services/runtime/pairing_manifest.rb README.md test/services/processes/launcher_test.rb test/services/processes/proxy_registry_test.rb test/integration/process_tools_flow_test.rb
