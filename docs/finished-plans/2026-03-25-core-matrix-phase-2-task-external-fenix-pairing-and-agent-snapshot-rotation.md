...
1. `AGENTS.md`
2. `docs/research-notes/2026-03-25-fenix-agent-snapshot-rotation-and-discourse-operations-research-note.md`
...
- if a new `Fenix` release cannot boot, treat that as an agent release
