...
```bash
git -C .. add core_matrix/README.md core_matrix/docs/behavior/shell-baseline.md core_matrix/test/support/.keep core_matrix/test/services/.keep core_matrix/test/queries/.keep core_matrix/test/integration/.keep core_matrix/test/requests/.keep core_matrix/script/manual/.keep docs/finished-plans/2026-03-24-core-matrix-phase-1-task-01-shell-baseline.md
