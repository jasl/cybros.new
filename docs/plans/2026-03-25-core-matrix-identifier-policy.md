...
rg -n "public_id|uuidv7|PostgreSQL 18|external lookup|ordering" docs/plans/2026-03-25-core-matrix-identifier-policy-design.md core_matrix/docs/behavior/identifier-policy.md AGENTS.md
```
...
**Files:**
- Modify: `docs/plans/2026-03-25-core-matrix-identifier-policy.md`
...
```bash
cd /Users/jasl/Workspaces/Ruby/cybros
sed -n '1,240p' docs/plans/2026-03-25-core-matrix-identifier-policy-design.md
