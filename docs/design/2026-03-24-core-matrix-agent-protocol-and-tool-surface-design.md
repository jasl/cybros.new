...
At minimum, the capability contract should expose:
...
- `tool_contract` describes agent-declared model-visible tools
- `tool_catalog` describes execution-runtime-callable tools
