module Runtime
  class ControlWorker
    def initialize(
      limit: Runtime::MailboxPump::DEFAULT_LIMIT,
      inline: false,
      control_client: nil,
      session_factory: nil,
      timeout_seconds: 5,
      mailbox_pump: Runtime::MailboxPump,
      control_loop: Runtime::ControlLoop,
      stop_condition: nil,
    ...
    def sweep_local_process_handles!
      Processes::Manager.prune_terminated_handles!
    end
    ...
    def run_control_loop
      ...
      Runtime::ControlLoop::Result.new(
        transport: "error",
