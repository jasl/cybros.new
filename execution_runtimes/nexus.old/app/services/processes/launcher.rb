module Processes
  ...
  def initialize(process_run:, command_line:, proxy_port: nil, control_client: nil, environment: nil, manager: Processes::Manager, proxy_registry: Processes::ProxyRegistry)
