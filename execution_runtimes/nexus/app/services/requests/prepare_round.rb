module Requests
  class PrepareRound
    ...
    def round_context
      @round_context ||= Shared::PayloadContext.call(
        payload: @payload,
        defaults: {
    ...
    def requested_skill_names
      @requested_skill_names ||= Skills::Catalog.requested_skill_names(messages: transcript_messages)
    end
    ...
    def skills_catalog
      @skills_catalog ||= begin
        repository = Skills::Repository.from_runtime_context!(
