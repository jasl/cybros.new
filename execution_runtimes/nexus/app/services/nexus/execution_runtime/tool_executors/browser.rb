        ...
        class Runtime
          ...
          def call
            ...
            when "browser_session_info"
              ...
              raise Nexus::ExecutionRuntime::Browser::SessionManager::ValidationError, "unsupported browser tool #{@tool_call.fetch("tool_name")}"
            end
          end
          ...
          def session_manager
            Nexus::ExecutionRuntime::Browser::SessionManager
          end
        end
      end
    end
