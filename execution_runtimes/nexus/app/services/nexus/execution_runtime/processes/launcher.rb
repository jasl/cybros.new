module Nexus
  module ExecutionRuntime
    module Processes
      ...
      def initialize(process_run:, command_line:, proxy_port: nil, control_client: nil, environment: nil, manager: Nexus::ExecutionRuntime::Processes::Manager, proxy_registry: Nexus::ExecutionRuntime::Processes::ProxyRegistry)
