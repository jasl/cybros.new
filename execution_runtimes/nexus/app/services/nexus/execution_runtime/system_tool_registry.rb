    ...
    class SystemToolRegistry
      ...
      [
        ...
        register!(
          ...
          executor: Nexus::ExecutionRuntime::ToolExecutors::ExecCommand,
        )
      end
      ...
      [
        ...
        register!(
          entries,
          catalog_entry: catalog_entry,
          executor: Nexus::ExecutionRuntime::ToolExecutors::Process,
        )
      end
      ...
      [
        ...
        register!(
          entries,
          catalog_entry: catalog_entry,
          executor: Nexus::ExecutionRuntime::ToolExecutors::Browser,
        )
      end
