  ...
  module Runtime
    class MailboxWorker
      ...
      def handle_process_run_close!
        self.class.instrument_execution(mailbox_item: @mailbox_item) do
          Nexus::ExecutionRuntime::Processes::Manager.close!(
      ...
      def enqueue_execution!
        ...
        Nexus::Runtime::MailboxExecutionJob.perform_later(
          @mailbox_item,
          deliver_reports: @deliver_reports,
          enqueued_at_iso8601: Time.current.iso8601(6),
          queue_name: Nexus::Runtime::MailboxExecutionJob.queue_name,
      ...
      def duplicate_delivery?
        Nexus::Shared::Values::MailboxDeliveryTracker.claim(
          mailbox_item_id: @mailbox_item.fetch("item_id"),
      ...
      def report_close_lifecycle!
        ...
        terminal = base_close_report("resource_closed").merge(
          ...
          "close_outcome_payload" => { "source" => "nexus_runtime" }
        )
      ...
      def resolved_control_client_if_needed
        ...
        @control_client = Nexus::Shared::ControlPlane.client
      end
