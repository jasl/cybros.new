  ...
  module Runtime
    class ExecuteMailboxItem
      ...
      def execute_execution_assignment!
        ...
        when "deterministic_tool"
          emit_execution_completion(
            Nexus::Runtime::Assignments::DeterministicTool.call(
              task_payload: mailbox_payload.fetch("task_payload", {})
            ),
            reports: reports
          )
      ...
      def execute_agent_request
        case request_kind
        when "prepare_round"
          Nexus::Agent::Requests::PrepareRound.call(payload: mailbox_payload)
        when "execute_tool"
          Nexus::Agent::Requests::ExecuteTool.call(
            payload: mailbox_payload,
            supported_system_tool_names: Nexus::ExecutionRuntime::SystemToolRegistry.supported_tool_names,
            system_tool_executor: system_tool_executor
          )
        when "supervision_status_refresh", "supervision_guidance"
          Nexus::Agent::Requests::ExecuteConversationControlRequest.call(payload: mailbox_payload)
        else
      ...
      def execution_assignment_error_payload_for(error)
        case error
        when Nexus::Agent::Skills::Repository::MissingScopeError
          {
            "classification" => "configuration",
        ...
        when Nexus::Agent::Skills::PackageValidator::InvalidSkillPackage
          {
        ...
        when Nexus::Agent::Skills::Repository::SkillNotFound
          {
            "classification" => "semantic",
        ...
        when Nexus::Agent::Skills::Repository::InvalidFileReference
          {
            "classification" => "semantic",
        ...
        when Nexus::Agent::Skills::Repository::ReservedSkillNameError
          {
            "classification" => "semantic",
        ...
        when Nexus::Runtime::Assignments::DeterministicTool::InvalidRequestError
          {
            "classification" => "semantic",
        ...
        when Nexus::Agent::Requests::ExecuteConversationControlRequest::InvalidRequestError
          {
            "classification" => "semantic",
