      ...
      class DispatchMode
        ...
        def call
          ...
          when "skills_catalog_list"
            skill_flow(Nexus::Agent::Skills::CatalogList.call(repository: repository))
          when "skills_load"
            skill_flow(
              Nexus::Agent::Skills::Load.call(
          ...
          when "skills_read_file"
            skill_flow(
              Nexus::Agent::Skills::ReadFile.call(
                skill_name: @task_payload["skill_name"].to_s,
          ...
          when "skills_install"
            skill_flow(
              Nexus::Agent::Skills::Install.call(
        ...
        def repository
          @repository ||= Nexus::Agent::Skills::Repository.from_runtime_context!(runtime_context: @runtime_context)
        end
