...
class Requests::ExecuteConversationControlRequestTest < ActiveSupport::TestCase
  test "status refresh returns a structured acknowledgment for the target conversation" do
    response = Requests::ExecuteConversationControlRequest.call(
      payload: {
  ...
  test "active-agent guidance rejects a mismatched subagent target" do
    error = assert_raises(Requests::ExecuteConversationControlRequest::InvalidRequestError) do
      Requests::ExecuteConversationControlRequest.call(
        payload: {
