...
class Shared::Values::MailboxDeliveryTrackerTest < ActiveSupport::TestCase
  teardown do
    Shared::Values::MailboxDeliveryTracker.reset!
  end

  test "keeps the most recent delivery number for a mailbox item" do
    tracker = Shared::Values::MailboxDeliveryTracker.new
  ...
  test "prunes oldest tracked deliveries once the cache exceeds its bound" do
    tracker = Shared::Values::MailboxDeliveryTracker.new
    max = Shared::Values::MailboxDeliveryTracker::MAX_TRACKED_DELIVERIES
