...
class Nexus::Shared::ControlPlane::ClientTest < ActiveSupport::TestCase
    ...
    assert_equal(
      {
        "base_url" => "https://core-matrix.example.test",
        "execution_runtime_connection_credential" => "execution-secret",
        "open_timeout" => Nexus::Shared::ControlPlane::Client::DEFAULT_OPEN_TIMEOUT,
        "read_timeout" => Nexus::Shared::ControlPlane::Client::DEFAULT_READ_TIMEOUT,
        "write_timeout" => Nexus::Shared::ControlPlane::Client::DEFAULT_WRITE_TIMEOUT,
      },
