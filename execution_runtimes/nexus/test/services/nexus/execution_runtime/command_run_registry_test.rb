...
class Nexus::ExecutionRuntime::CommandRunRegistryTest < ActiveSupport::TestCase
  test "list and output snapshot expose local attached command projections" do
    ...
    begin
      ...
      entries = Nexus::ExecutionRuntime::CommandRunRegistry.list(runtime_owner_id: "task-1")
