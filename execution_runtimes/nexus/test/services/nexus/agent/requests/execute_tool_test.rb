...
class Nexus::Agent::Requests::ExecuteToolTest < ActiveSupport::TestCase
  test "executes the shared calculator contract fixture" do
    ...
    response = Nexus::Agent::Requests::ExecuteTool.call(payload: fixture_payload)
  ...
  test "delegates system tool execution through an injected boundary" do
    ...
    captured = nil
    response = Nexus::Agent::Requests::ExecuteTool.call(
      payload: payload,
