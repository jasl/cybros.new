...
class Nexus::Runtime::MailboxWorkerPerfTest < ActiveSupport::TestCase
  ...
  test "publishes mailbox execution perf event for inline execution" do
    ...
    Nexus::Runtime::ExecuteMailboxItem.singleton_class.define_method(:call) do |**kwargs|
      {
        "status" => "ok",
    ...
    Nexus::Runtime::ExecuteMailboxItem.singleton_class.define_method(:call, original_execute)
  end
  ...
  test "publishes mailbox execution error metadata when inline execution raises" do
    ...
    Nexus::Runtime::ExecuteMailboxItem.singleton_class.define_method(:call) do |**_kwargs|
      raise "boom"
    end
  ...
  test "enqueues mailbox execution job with queue timing metadata" do
    assert_enqueued_with(
      job: Nexus::Runtime::MailboxExecutionJob,
