...
class Nexus::Runtime::ExecuteMailboxItemTest < ActiveSupport::TestCase
  ...
  test "prepare_round agent requests emit a completed terminal report" do
    ...
    Dir.mktmpdir("nexus-workspace-") do |workspace_root|
      ...
      result = Nexus::Runtime::ExecuteMailboxItem.call(
  ...
  test "execute_tool forwards the control client into execution-runtime-backed process tools" do
    ...
    original_new = Nexus::ExecutionRuntime::ToolExecutor.method(:new)

    Nexus::ExecutionRuntime::ToolExecutor.define_singleton_method(:new) do |context:, collector: nil, control_client: nil, cancellation_probe: nil|
    ...
    Nexus::ExecutionRuntime::ToolExecutor.define_singleton_method(:new, original_new) if original_new
  end
  ...
  test "unsupported execution assignment dispatch kinds fail with a configuration terminal payload" do
    client = RuntimeControlClientDouble.new(reported_payloads: [])
    original_call = Nexus::Runtime::Assignments::DispatchMode.method(:call)

    Nexus::Runtime::Assignments::DispatchMode.define_singleton_method(:call) do |**|
    ...
    Nexus::Runtime::Assignments::DispatchMode.define_singleton_method(:call, original_call) if original_call
  end
