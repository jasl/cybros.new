...
module Verification
  module Perf
    class Topology
      class << self
        def build(profile:, repo_root:, verification_root:, artifact_stamp:, runtime_host: "127.0.0.1", runtime_scheme: "http", runtime_base_port: 3201, proxy_base_port: 3410, container_prefix: "nexus-load")
          new(
            profile: profile,
      ...
      def initialize(profile:, repo_root:, verification_root:, artifact_stamp:, runtime_host:, runtime_scheme:, runtime_base_port:, proxy_base_port:, container_prefix:)
        @profile_name = profile.name
        @artifact_root = verification_root.join("artifacts", artifact_stamp)
      ...
      def build_slots(profile:, repo_root:, verification_root:, artifact_stamp:, runtime_host:, runtime_scheme:, runtime_base_port:, proxy_base_port:, container_prefix:)
