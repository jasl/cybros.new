...
bundled_configuration = {
  enabled: true,
  agent_key: "verification-d-human",
  display_name: "Verification Human Wait Runtime",
  visibility: "public",
  provisioning_origin: "system",
  lifecycle_state: "active",
  execution_runtime_kind: "local",
  execution_runtime_fingerprint: "verification-d-human-environment",
  ...
  fingerprint: "verification-d-human-runtime",
...
Verification::ManualSupport.dispatch_execution_report!(
  ...
  protocol_message_id: "verification-human-start",
...
Verification::ManualSupport.dispatch_execution_report!(
  ...
  protocol_message_id: "verification-human-complete",
  terminal_payload: {
    "output" => "Need operator input",
    "wait_transition_requested" => {
      "batch_manifest" => {
        "batch_id" => "verification-human-batch",
        ...
        "stages" => [
          {
            ...
            "intents" => [
              {
                "intent_id" => "verification-human-batch:human",
                ...
                "idempotency_key" => "verification-human-batch:human",
              },
            ],
          },
        ],
