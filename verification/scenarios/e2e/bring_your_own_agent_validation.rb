...
bring_your_own_agent = Verification::ManualSupport.app_api_admin_create_onboarding_session!(
  target_kind: "agent",
  agent_key: "bring-your-own-agent",
  display_name: "Bring Your Own Agent",
  session_token: app_api_session_token
)
registration = Verification::ManualSupport.register_bring_your_own_runtime!(
  onboarding_token: bring_your_own_agent.fetch("onboarding_token"),
  runtime_base_url: runtime_base_url,
  agent_base_url: agent_base_url,
  execution_runtime_fingerprint: "verification-bring-your-own-agent-environment"
)
...
Verification::ManualSupport.with_fenix_control_worker!(
  ...
  Verification::ManualSupport.with_nexus_control_worker_for_registration!(
    ...
    run = run.merge(
      ...
      report_results: Verification::ManualSupport.report_results_for(agent_task_run:)
    )
  end
end
