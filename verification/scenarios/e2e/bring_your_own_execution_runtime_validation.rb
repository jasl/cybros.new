...
artifact_stamp = ENV.fetch("BRING_YOUR_OWN_EXECUTION_RUNTIME_ARTIFACT_STAMP") do
  "#{Time.current.strftime("%Y-%m-%d-%H%M%S")}-bring-your-own-execution-runtime-validation"
end
...
bundled_registration = Verification::ManualSupport.register_bundled_runtime_from_manifest!(
  ...
  execution_runtime_fingerprint: "verification-bundled-fenix-environment",
  fingerprint: "verification-bundled-fenix-runtime"
)
...
bring_your_own_runtime_registration = Verification::ManualSupport.register_bring_your_own_execution_runtime!(
  ...
  execution_runtime_fingerprint: "verification-bring-your-own-runtime-environment"
)
