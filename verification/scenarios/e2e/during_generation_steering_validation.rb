...
# This scenario intentionally exercises steering, policy-gate, and stale-work workflow semantics because there is no equivalent app_api surface.
...
bundled_configuration = {
  enabled: true,
  agent_key: "verification-d-steering",
  display_name: "Verification Steering Runtime",
  visibility: "public",
  provisioning_origin: "system",
  lifecycle_state: "active",
  execution_runtime_kind: "local",
  execution_runtime_fingerprint: "verification-d-steering-environment",
  ...
  fingerprint: "verification-d-steering-runtime",
