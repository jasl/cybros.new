...
require "verification/suites/perf/runtime_slot"

module Verification
  module Perf
    class RuntimeSlotTest < Minitest::Test
      REPO_ROOT = Pathname.new(File.expand_path("../../..", __dir__))
      VERIFICATION_ROOT = REPO_ROOT.join("verification")
      ...
      def test_runtime_slots_derive_unique_ports_storage_and_event_paths
        ...
        assert_equal VERIFICATION_ROOT.join("artifacts", "2026-04-09-baseline-1-fenix-4-nexus", "evidence", "nexus-01-events.ndjson"), slot_one.event_output_path
        assert_equal VERIFICATION_ROOT.join("artifacts", "2026-04-09-baseline-1-fenix-4-nexus", "evidence", "nexus-02-events.ndjson"), slot_two.event_output_path
      ...
      def test_slot_can_render_nexus_activation_env
        ...
        assert_equal VERIFICATION_ROOT.join("artifacts", "2026-04-09-baseline-1-fenix-4-nexus", "evidence", "nexus-03-events.ndjson").to_s, env.fetch("CYBROS_PERF_EVENTS_PATH")
