...
AGENT_CONNECTION_CREDENTIAL="${AGENT_CONNECTION_CREDENTIAL:?AGENT_CONNECTION_CREDENTIAL is required}"
AGENT_EXECUTION_RUNTIME_CONNECTION_CREDENTIAL="${AGENT_EXECUTION_RUNTIME_CONNECTION_CREDENTIAL:-${AGENT_CONNECTION_CREDENTIAL}}"
...
AGENT_HOME_ROOT_ENV_KEY="${AGENT_HOME_ROOT_ENV_KEY:-}"
AGENT_HOME_ROOT_PATH="${AGENT_HOME_ROOT_PATH:-}"
AGENT_PERF_EVENTS_PATH="${AGENT_PERF_EVENTS_PATH:-}"
AGENT_PERF_INSTANCE_LABEL="${AGENT_PERF_INSTANCE_LABEL:-}"
...
docker run -d \
  ...
  ${AGENT_HOME_ROOT_ENV_KEY:+-e "${AGENT_HOME_ROOT_ENV_KEY}=${AGENT_HOME_ROOT_PATH}"} \
  ...
  -e "CORE_MATRIX_AGENT_CONNECTION_CREDENTIAL=${AGENT_CONNECTION_CREDENTIAL}" \
  -e "CORE_MATRIX_EXECUTION_RUNTIME_CONNECTION_CREDENTIAL=${AGENT_EXECUTION_RUNTIME_CONNECTION_CREDENTIAL}" \
  ${AGENT_PERF_EVENTS_PATH:+-e "CYBROS_PERF_EVENTS_PATH=${AGENT_PERF_EVENTS_PATH}"} \
  ${AGENT_PERF_INSTANCE_LABEL:+-e "CYBROS_PERF_INSTANCE_LABEL=${AGENT_PERF_INSTANCE_LABEL}"} \
