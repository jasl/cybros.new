...
require_relative "../lib/capstone_review_artifacts"
...
bundled_configuration = {
  enabled: true,
  agent_key: "acceptance-specialist-export",
  display_name: "Acceptance Specialist Export Runtime",
  visibility: "public",
  provisioning_origin: "system",
  lifecycle_state: "active",
  execution_runtime_kind: "local",
  execution_runtime_fingerprint: "acceptance-specialist-export-environment",
  ...
  fingerprint: "acceptance-specialist-export-runtime",
...
Acceptance::ManualSupport.dispatch_execution_report!(
  ...
  protocol_message_id: "acceptance-specialist-start",
...
Acceptance::ManualSupport.dispatch_execution_report!(
  ...
  protocol_message_id: "acceptance-specialist-complete",
  terminal_payload: {
    "output" => "Delegated the verification step to tester",
    "wait_transition_requested" => {
      "batch_manifest" => {
        "batch_id" => "acceptance-specialist-batch",
        ...
        "stages" => [
          {
            ...
            "intents" => [
              {
                "intent_id" => "acceptance-specialist-batch:subagent:0",
                ...
                "idempotency_key" => "acceptance-specialist-batch:subagent:0",
              },
            ],
          },
        ],
...
conversation_export = Acceptance::ManualSupport.app_api_export_conversation!(
  conversation_id: conversation.public_id,
  session_token: app_api_session_token,
  destination_path: conversation_export_path
)
conversation_debug_export = Acceptance::ManualSupport.app_api_debug_export_conversation!(
  conversation_id: conversation.public_id,
  session_token: app_api_session_token,
