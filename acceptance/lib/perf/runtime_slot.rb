...
module Acceptance
  module Perf
    class RuntimeSlot
      class << self
        def build(index:, run_slug:, repo_root:, acceptance_root:, artifact_stamp:, runtime_host: "127.0.0.1", runtime_scheme: "http", runtime_base_port: 3201, proxy_base_port: 3410, container_prefix: "nexus-load")
